// csamisc_anonymousnamespaceinheader.cpp                             -*-C++-*-
...
static void anonymous_namespace_in_header(Analyser& analyser,
...
static RegisterCheck check(check_name, &anonymous_namespace_in_header);
