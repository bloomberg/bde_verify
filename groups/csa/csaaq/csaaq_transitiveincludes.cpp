...
#define X(a, b) s[a] = b;
    ...
    X("/bslstl_charconv.h",                   "bsl_charconv.h"     )
    ...
    X("/bslstl_stringview.h",                 "bsl_string_view.h"  )
...
{
    name = llvm::sys::path::filename(name).str();
